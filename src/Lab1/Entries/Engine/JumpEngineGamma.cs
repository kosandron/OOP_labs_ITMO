...
public class JumpEngineGamma : JumpEngineBase
{
    ...
    public JumpEngineGamma(GalacticBase? possibleGalactic, int maxJumpDistanse = 3000, int speed = BasicStartSpeed, int gasTankReserve = 0)
