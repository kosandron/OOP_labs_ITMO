...
public abstract class DeflectorBase
{
    ...
    public HitPoints State { get; private set; }
    public FotonicDeflectorBase FotonicDeflector { get; private set; }
    ...
    public void StateFotonicDeflector()
    {
        FotonicDeflector = new FotonicDeflectorBase();
    }
}
